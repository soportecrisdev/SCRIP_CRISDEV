...
menu_protocolos() {
    while true; do
        ...
        case "$proto_opt" in
            ...
            7|07) menu_udp_cris ;;
            8|08)
                [[ -f /bin/hysteria2-manager && ! -s /bin/hysteria2-manager ]] && rm -f /bin/hysteria2-manager
                if [[ -s /bin/hysteria2-manager && -x /bin/hysteria2-manager ]]; then
                    /bin/hysteria2-manager
                elif [[ -s /usr/bin/hysteria2-manager && -x /usr/bin/hysteria2-manager ]]; then
                    /usr/bin/hysteria2-manager
                    ...
                    if [[ -s /bin/hysteria2-manager ]]; then
                        ...
                        echo -e "\033[1;31mError al descargar Hysteria v2 Manager. Verifique conexion o actualice el repositorio.\033[0m"
                        sleep 2
                    fi
                fi
                ;;
            9|09)
                [[ -f /bin/udp-custom-manager && ! -s /bin/udp-custom-manager ]] && rm -f /bin/udp-custom-manager
                if [[ -s /bin/udp-custom-manager && -x /bin/udp-custom-manager ]]; then
                    /bin/udp-custom-manager
                elif [[ -s /usr/bin/udp-custom-manager && -x /usr/bin/udp-custom-manager ]]; then
                    /usr/bin/udp-custom-manager
                    ...
                    if [[ -s /bin/udp-custom-manager ]]; then
                        ...
                        echo -e "\033[1;31mError al descargar UDP Custom Manager. Verifique conexion o actualice el repositorio.\033[0m"
                        sleep 2
                    fi
                fi
                ;;
