...
fun_udp1 () {
    ...
    menu
	    ...
	    inst_udp () {
            ...
            wget https://raw.githubusercontent.com/soportecrisdev/SCRIP_CRISDEV/main/badvpn/badvpn-udpgw -o /dev/null
			wget https://raw.githubusercontent.com/soportecrisdev/SCRIP_CRISDEV/main/badvpn/antcrashvpn.sh -o /dev/null
